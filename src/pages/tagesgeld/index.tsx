...
const Offers = () => {
  ...
  return (
    <>
      ...
      {/* <PageLayout> */}
      <UserData />
      <div className="flex w-full justify-center items-center gap-x-[15px]">
        <div className="max-w-[255px] mt-[30px]">
          <Input
            type="text"
            lable=""
            value={inputValue}
      ...
      <div className="flex justify-center">
        <div className="w-full max-w-[1276px] flex px-5 mt-[30px]">
          ...
          <div
            className="flex max-w-[75px] md:max-w-[175px] -ml-[55px] md:ml-0 gap-x-2 w-full cursor-pointer"
          ...
          <div className="flex gap-x-2 w-full md:ml-[35px] -ml-0 max-w-[175px]">
