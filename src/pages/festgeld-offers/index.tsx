...
export default function FixedDeposit() {
  ...
  const filterData = () => {
    ...
    if (selectedDuration.id !== 0) {
      filteredData = filteredData.filter(
        (item) =>
          item.duration / 12 === parseInt(selectedDuration.name as string)
      );
    }
    const filteredBanks = [];
    ...
    <>
      ...
      <div className="w-full h-[380px] relative flex justify-center">
        <div className="w-full max-w-[1276px] absolute z-10">
          <h1 className="text-white text-4xl md:text-[56px] leading-[62px] ml-[20px] md:ml-0 mt-[120px] md:mt-[196px]">
            Festgeld wählen –
            <br /> von Top-Zinsen profitieren
          </h1>
        </div>
        <div className="relative w-full h-[380px] ">
          <div className="w-1/2 bg-[#44403C]  absolute -z-10 h-full"></div>
          <Image
            src={"/assets/images/fixed-offers-header.png"}
            alt=""
            fill
            className=" -mt-[1px]"
          />
          <div className="w-1/2 bg-[#44403C]  absolute -z-10 h-full right-0"></div>
        </div>
      </div>
      <div className="w-full flex p-5 ml:p-0 justify-center bg-white gap-x-5 mt-[80px]">
        <div className="w-full flex flex-col items-center max-w-[1276px]">
          ...
          <div className="flex flex-wrap lg:flex-nowrap gap-8 mt-[30px] mb-[80px]">
      ...
      <div className="w-full flex justify-center bg-white gap-x-5">
        <div className="w-full flex flex-col items-center max-w-[1276px]">
          <div className="flex bg-body p-1 w-full rounded">
            <div className="h-full w-1/2 flex flex-col bg-white items-center justify-center py-3 rounded cursor-pointer">
              <h3 className="font-bold text-dark">FESTGELD</h3>
              <p className="text-gray3">Aus ganz Europa</p>
            </div>
            <div
              className="h-full w-1/2 flex flex-col items-center justify-center py-3 cursor-pointer"
              onClick={toDailyOffers}
            >
              <h3 className="font-bold text-gray1">TAGESGELD</h3>
              <p className="text-gray1">Jederzeit verfügbar</p>
            </div>
          </div>
      ...
      <div className="w-full flex justify-center bg-header">
        <div className="w-full max-w-[1276px] flex  p-5 flex-col items-center pt-[80px] pb-[84px]">
          <h2 className="text-white text-4xl">
            Vorteile von Tagesgeld auf einen Blick
          </h2>
          <div className="flex flex-col md:flex-row gap-8 mt-[30px]">
            <div className="border-b border-solid border-gray2 bg-white flex flex-col items-center max-w-[622px] w-full h-[380px] rounded-lg p-[30px]">
              <Image
          ...
          <div className="flex flex-col md:flex-row gap-8 mt-[32px]">
            <div className="border-b border-solid border-gray2 bg-white flex flex-col items-center max-w-[622px] w-full h-[380px] rounded-lg p-[30px]">
              <Image
      ...
      <div className="w-full flex p-5 lg:p-0 justify-center bg-white">
      ...
      <div className="w-full flex p-5 lg:p-0 justify-center bg-white">
        <div className="w-full max-w-[1276px] flex flex-col items-center gap-x-[60px] pt-[80px] pb-[84px]">
          ...
          <div className="flex flex-wrap lg:flex-nowrap justify-center lg:justify-normal gap-8 mt-[30px]">
      ...
      <div className="w-full flex justify-center p-5 md:p-0 bg-body">
        <div className="w-full max-w-[1276px] flex items-start gap-x-[60px] pt-[80px] pb-[84px]">
          <div>
